...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.enable_aqn.setText(_translate("MainWindow", "Apply Setting / Start Presence"))
        ...
        self.enable_fake.setText(_translate("MainWindow", "Apply Setting / Start Presence"))
        self.mod_combobox.setCurrentText(_translate("MainWindow", "standard"))
        self.mod_combobox.setItemText(0, _translate("MainWindow", "standard"))
        self.mod_combobox.setItemText(1, _translate("MainWindow", "Taiko"))
        self.mod_combobox.setItemText(2, _translate("MainWindow", "Catch the Beat"))
        self.mod_combobox.setItemText(3, _translate("MainWindow", "mania"))
